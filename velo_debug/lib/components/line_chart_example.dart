...
class LineChartStream extends StatelessWidget {
  const LineChartStream({required this.isShowingMainData});
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: LineChartStream(isShowingMainData: isShowingMainData),
                  ),
                ),
                const SizedBox(
                  height: 10,
